<div class="hm_footer_wrapper">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="hm_footer_box">
                            <a href="index.php"><img src="images/logo.jpg" alt="handmade-craft-logo" class="img-responsive">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="hm_footer_box">
                            ...
                            <ul>
                                <li><a href="services.php">Customer Service</a></li>
                        ...
                        <div class="hm_footer_box hm_footer_contact">
                            ...
                            <ul>
                                <li><span class="footer_icon"><i class="fa fa-map-marker" aria-hidden="true"></i> </span>
                                    <p class="foo_con_para">A-09 , Sector-62, Noida,Uttar Pradesh </p>
                                </li>
                                <li><span class="footer_icon"><i class="fa fa-phone" aria-hidden="true"></i> </span>
                                    <p class="foo_con_para">+9100123654789 +9100123456788</p>
                                </li>
                                <li><a href="mailto:jhini.mehta@gmail.com"><span class="footer_icon"><i class="fa fa-envelope" aria-hidden="true"></i> </span><p class="foo_con_para">mgm@coet.in</p></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <p> &copy; 2020 All Rights Reserved by Alpha Leporis</p>
                    </div>
                </div>
            </div>
             </div>
    ...
    <script type="text/javascript" src="js/plugin/range_slider/jquery-ui.js"></script>
