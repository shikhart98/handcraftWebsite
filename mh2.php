...
echo '
<div class="hm_news_wrmhper shop_single">
...
<div class="hm_product_details">
 ...
 <div class="img_box" style="border:3px solid #f1f1f1">
       ...
       <img src="assets/mh/jok.jpg" alt="" class="img-responsive" />
...
<h2 class="hm_text">Jewellery of Kolhapur</h2>
...
<button type="button" class="plus"><span class="fa fa-plus"></span></button>
 ...
 <button type="button" class="hm_bmh add-to-cart"> Add To Cart </button>
