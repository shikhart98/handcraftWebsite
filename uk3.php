...
<div class="hm_product_details">
 ...
 <div class="img_box" style="border:3px solid #f1f1f1">
       ...
       <img src="assets/uk/pp.jpg" alt="" class="img-responsive" />
...
<h2 class="hm_text">Pahari Paintings</h2>
...
<button type="button" class="plus"><span class="fa fa-plus"></span></button>
 ...
 <button type="button" class="hm_buk add-to-cart"> Add To Cart </button>
...
<h2 class="hm_text">Pahari Dolls</h2>
